...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative bg-green-500 hover:bg-green-600 text-white w-12 h-12 rounded-full shadow-lg flex items-center justify-center transition-colors"
        style={{ boxShadow: "0 4px 15px rgba(34, 197, 94, 0.4)" }}
      >
        {/* Pulse */}
        <span className="absolute inset-0 bg-green-400 opacity-30 rounded-full animate-ping" />
